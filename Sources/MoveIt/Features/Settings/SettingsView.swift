...
struct SettingsView: View {
    ...
    private var routingSection: some View {
        Section {
            ...
            Text("Walking legs are straight-line distances with an allowance for detours. Move It does not download street maps, which is part of how it stays small and offline.")
        }
    }
    ...
    private var aboutSection: some View {
        Section {
            NavigationLink {
                ...
                Label(String(localized: "How Move It works"), systemImage: "info.circle")
            }
    ...
    var body: some View {
        List {
            ...
            Section {
                ...
                Text("Published transit data often contains errors. Anything Move It could not use is listed here rather than hidden.")
            }
        }
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: Theme.Spacing.medium) {
                ...
                Text("Most transit apps send your starting point and destination to a server, which works out the route and sends it back. Move It does that work on your phone instead.")

                Text("When you install a city, Move It downloads the timetable that the transit agency publishes for free, and compiles it into a compact index stored on the device. Searching for a journey then reads that index directly — typically in well under a second — with no network involved.")
                ...
                Text("Live delays still need a connection, and only some agencies publish them. When there is no live data, Move It shows scheduled times and says so rather than pretending to know.")

                Text("Timetables also expire. Move It warns you before yours does, because an out-of-date timetable that looks fine is worse than none at all.")
            }
